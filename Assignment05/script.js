...
(function () {
    ...
    function fnFight() {
        ...
        if (heroAll[randomHero].power() === villainAll[randomVillain].power()) {
            ...
            elDivLeftCol.innerHTML = "<h2>" + heroAll[randomHero].name + ' ( Power: '+ heroAll[randomHero].power()+')'+"</h2>";
            ...
            elDivRightCol.innerHTML = "<h2>" + villainAll[randomVillain].name + ' ( Power: ' +villainAll[randomVillain].power()+')'+"</h2>";
